...
config_path = 'classification/config/efficientnet/test2_efficientnet-b7_8xb32_in1k_WCE.py'
checkpoint_path = 'classification/weight/swa_efficient_b7_album_102e_last_5_checkpoint_classification.pth'
store_path = Path('classification/work_dirs/test2_efficientnet-b7_8xb32_in1k_WCE/vis_images')
